...
if __name__=="__main__":
    f_train = open("shop_data/train_data", "r")
    user_dict = {}
    item_dict = {}
    cat_dict = {}
    ...
    with open("shop_data/user_vocab.pkl", "wb") as f:
        pickle.dump(uid_voc, f, pickle.HIGHEST_PROTOCOL)
    with open("shop_data/item_vocab.pkl", "wb") as f:
        pickle.dump(mid_voc, f, pickle.HIGHEST_PROTOCOL)
    with open("shop_data/category_vocab.pkl", "wb") as f:
        pickle.dump(cat_voc, f, pickle.HIGHEST_PROTOCOL)

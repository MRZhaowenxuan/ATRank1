...
import random
import math
from sli_rec_az.utils import shuffle
...
class Iterator:
    def __init__(self, source,
                 uid_voc="../preprocess/shop_data/user_vocab.pkl",
                 mid_voc="../preprocess/shop_data/item_vocab.pkl",
                 cat_voc="../preprocess/shop_data/category_vocab.pkl",
                 batch_size=128,
                 max_batch_size=20):
...
# train_data = Iterator("data/train_data")

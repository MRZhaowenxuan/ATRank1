...
from BisIE_mask_prc.input import DataInput, DataInputTest
from BisIE_mask_prc.model_new import Model
...
def train():
    ...
    with open('../BisIE_mask_prc/tianchi/dataset.pkl', 'rb') as f:
    ...
    model.save(sess)
    u_emb = []
    u_emb.append(model.u_emb)
    with open('u_emb.pkl', 'wb') as f:
        pickle.dump(u_emb, f, pickle.HIGHEST_PROTOCOL)
